...
const Banner = () => {
  return (
    <Carousel opts={{ watchDrag: false }} className="w-full">
      <CarouselContent>
        <CarouselItem>
          <div className="relative w-full min-h-[calc(100svh-66px)] grid md:grid-cols-2 bg-[#F5F0E8]">
            <div className="flex flex-col justify-center px-page gap-6 py-16 md:py-0">
            ...
            <div className="relative w-full h-90 md:h-full md:min-h-[calc(100svh-80px)]">
              <Image
                fill
                alt="banner-image"
        ...
        <CarouselItem>
          <div className="relative w-full md:min-h-[calc(100svh-66px)] grid md:grid-cols-2 bg-[#E8E6F0]">
            <div className="flex flex-col justify-center px-page gap-6 py-16 md:py-0">
